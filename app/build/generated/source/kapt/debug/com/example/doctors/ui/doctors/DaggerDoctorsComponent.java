...
public final class DaggerDoctorsComponent implements DoctorsComponent {
  private com_example_doctors_root_ApplicationComponent_myRealmQueries myRealmQueriesProvider;
  ...
  private void initialize(final Builder builder) {
    this.myRealmQueriesProvider =
        new com_example_doctors_root_ApplicationComponent_myRealmQueries(
            builder.applicationComponent);
    this.provideDoctorsModelProvider =
        DoubleCheck.provider(
            DoctorsModule_ProvideDoctorsModelFactory.create(
                builder.doctorsModule, myRealmQueriesProvider));
    ...
    this.providesHandlerProvider =
        DoubleCheck.provider(DoctorsModule_ProvidesHandlerFactory.create(builder.doctorsModule));
    this.provideDoctorsHelperProvider =
        DoubleCheck.provider(
            DoctorsModule_ProvideDoctorsHelperFactory.create(
                builder.doctorsModule,
                applicationProvider,
                contentDownloaderServiceProvider,
                restApiProvider,
  ...
  private static class com_example_doctors_root_ApplicationComponent_myRealmQueries
      implements Provider<MyRealmQueries> {
    private final ApplicationComponent applicationComponent;

    com_example_doctors_root_ApplicationComponent_myRealmQueries(
        ApplicationComponent applicationComponent) {
      this.applicationComponent = applicationComponent;
    }

    @Override
    public MyRealmQueries get() {
      return Preconditions.checkNotNull(
          applicationComponent.myRealmQueries(),
